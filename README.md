...
* tuplelist: Μία λίστα από node_tuples. Υπάρχει μία τέτοια για κάθε list_node. Καθώς δεν χρησιμοποιήσαμε το description των json files τους, αλλά μόνο το url/id τους, καταχωρίσαμε αυτά τα ζευγάρια σε μ>* hash_map/hash_bucket: Υλοποίηση ενός τυπικού στατικού πίνακα κατακερματισμού. Κάθε bucket περιέχει μία λίστα των list_nodes των οποίων τα ids αντιστοιχούν σε αυτόν.
