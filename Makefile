...
MULTI_MODS = datatypes.c tuplist.c hashmap.c BOW/vectorOps.c TF-IDF/tf.c TF-IDF/idfVectorOps.c multithreading/multithreading_pseudocode.c multithreading/queue.c multithreading/queueelement.c multithreading/routines.c
...
multi:
	gcc $(FLAGS) tests/multithreading_tests/mult tests/multithreading_tests/mult.o $(MULTI_MODS) -DBUCKETS=2  -DCOEFFAMOUNT=15 $(LINKS) 
